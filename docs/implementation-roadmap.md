...
1. Domain models and source registry.
2. Ingestion skeleton that writes local JSONL raw documents.
3. Source connectors for approved API-first sources.
4. Cleaning, deduplication, and metadata normalization.
